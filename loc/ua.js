module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'імпорт',
      explanation: 'Мнемоніка, приватний ключ, чи будь що. VelesWallet спробуе вгадати вірний формат',
      imported: 'імпортовано',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'Щоб зберегти ваші біткоїни в безпеці, VelesWallet може створити ' +
      'ще одне зашифроване сховище, з іншим паролем. Під тиском, ' +
      'ви можете розкрити третім особам цей пароль. Якщо ввести цей пароль ' +
      "VelesWallet, розблоковується 'фальшиве' сховище. Це виглядатиме " +
