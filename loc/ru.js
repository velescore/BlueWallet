module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'Импорт',
      explanation: 'Напиши тут свою мнемоническую фразу, приватный ключ, WIF - что угодно! VelesWallet постарается угадать верный формат',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'Чтобы сохранить свой Bitcoin в безопасности, VelesWallet может создать ' +
      ...
      "VelesWallet, разблокируется 'фальшивое' хранилище. Это будет выглядеть " +
